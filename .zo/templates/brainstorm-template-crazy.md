...
#### 1. ✅ [Idea Title] (Type: [Blue Sky 🚀 / Bedrock 🏗️ / Strategic 🎯])
...
#### 2. ✅ [Idea Title] (Type: [Blue Sky 🚀 / Bedrock 🏗️ / Strategic 🎯])

_Repeat same structure as Idea 1_

---

#### [N]. ✅ [Idea Title] (Type: [Blue Sky 🚀 / Bedrock 🏗️ / Strategic 🎯])

_Repeat same structure_

---

### Rejected Ideas ([N] total)

- ❌ [Idea 1]: [Why rejected - not 10x, too risky, wrong timing]
- ❌ [Idea 2]: [Why rejected]
- ❌ [Idea 3]: [Why rejected]
...
| ------------ | ------ | ------ | ---- | -------- | ------------------ |
| #[N] [Title] | 🔥🔥🔥 | [X]w   | Low  | **P0**   | [Why must-have]    |
| #[N] [Title] | 🔥🔥   | [X]w   | Med  | **P1**   | [Why should-have]  |
| #[N] [Title] | 🔥     | [X]w   | High | **P2**   | [Why nice-to-have] |
| #[N] [Title] | 🔥     | [X]w   | High | **P3**   | [Strategic bet]    |
