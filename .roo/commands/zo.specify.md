...
8. Report completion with branch name, spec file path, design file path (if --design was used), checklist results, and readiness for the next phase (`/zo.clarify` or `/zo.plan`).
